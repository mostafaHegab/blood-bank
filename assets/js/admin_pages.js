...
var Sohag_cities = [
    ...
    for (var i = 0; i < governerate.length; i++) {
        htmlcontent = htmlcontent + "<option value='" + governerate[i].id + "'>" + governerate[i].governorate_name_en + "</option>";
    }
...
$("#inputState").change(function () {
    ...
    for (var i = 0; i < optionsList.length; i++) {
        htmlString = htmlString + "<option value='" + optionsList[i].id + "'>" + optionsList[i].city_name_en + "</option>";
    }
